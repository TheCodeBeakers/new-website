...
import sd_img from "../Assets/sd.png";
import web3_img from "../Assets/web3.png";
...
const Final = () => { 
    ...
    return(
            ...
            <div className={Styles.domCont}>
                <div className={Styles.doms1}>
                    <div className={Styles.doms}>
                        <div className={Styles.domLeft}>
                            <img src={cp_img} alt="" />
                        </div>
                        <div className={Styles.domRight}>
                ...
                <div className={Styles.doms2}>
                    <div className={Styles.doms}>
                        <div className={Styles.domLeft}>
                            <img src={ml_img} alt="" />
                        </div>
                        <div className={Styles.domRight}> <h1>Fullstack Web Development</h1>
                        <p>
                ...
                <div className={Styles.doms3}>
                    <div className={Styles.doms}>
                        <div className={Styles.domLeft}>
                            <img src={sd_img} alt="" />
                        </div>
                        <div className={Styles.domRight}> <h1>Android Development</h1>
                            <p>
                ...
                <div className={Styles.doms4}>
                    <div className={Styles.doms}>
                        <div className={Styles.domLeft}>
                            <img src={web3_img} alt="" />
                        </div>
                        <div className={Styles.domRight}> <h1>Web 3.0</h1>
                        <p>
